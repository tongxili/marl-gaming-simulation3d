...
class Runner_MAPPO_MPE:
    ...
    def run_display(self, ): # visualize 
        ...
        while True:
            ...
            red_win=True
            episode_no = 0
            for episode_no in range(self.args.episode_limit):
                ...
                if all(done_n):
                    ...
                    if len(info_n)>0 and info_n[0]=="Blue wins!": # have problem
                        red_win=False
                        print("Blue wins! episode no", episode_no)
                    else:
                        # red_win_rate[0] += 1
                        print("Red wins!")
                    break
            ...
            if(red_win):
                red_win_rate[0] += 1
            print("{} episode ends! red_win_rate:{}".format(episode_no, red_win_rate[0]/red_win_rate[1]))
